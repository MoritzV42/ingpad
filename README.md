...
- **[ingpad](https://github.com/MoritzV42/ingpad)** — A patient AI tutor on a canvas: it reads your handwriting, checks every step of a technical exercise, and explains what is missing — solve, don’t copy. *(this repo)*
